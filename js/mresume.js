...
drawAbility('canvas-php', 85, '#5c9beb');

drawAbility('canvas-mysql', 90, '#eb86c0');

drawAbility('canvas-html', 80, '#ec5463');

drawAbility('canvas-js', 65, '#e5e8ed');

drawAbility('canvas-mvc', 55, '#9fd367');

drawAbility('canvas-linux', 60, '#fecd54');

drawAbility('canvas-ds', 20, '#f69292');

drawAbility('canvas-cpp', 30, '#e5d');
...
function AnimationPage0() {
  if (document.getElementById('cover-img').style.webkitAnimation == 'ani-cover-img 1s') {
    ...
    document.getElementById('cover-push').style.webkitAnimation = 'ani-cover-push2 1s';
  } else {
    ...
    document.getElementById('cover-push').style.webkitAnimation = 'ani-cover-push 1s';
  }
}
